...
module.exports = {
    config: {
        ...
        category: ["economy"],
        description: "Explore the MuxDay marketplace.",
    ...
    run: async (client, message, args) => {
        ...
        message.channel.send(`It appears that you don't have an account yet! Use \`${client.prefix}createacc\` to register yourself to the MuxDay database!`);
        }
}
}
