...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        message.channel.send(`You begged for money, but sadly no one responded. Because you do not have citizenship status. Use \`${client.prefix}createacc\` to register yourself to the MuxDay database!`);
